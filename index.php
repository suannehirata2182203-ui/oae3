...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 3624;
        $headers['auth']['clientCompany'] = "qi73dzArtZ0ipucH4T11";
        $headers['auth']['clientSecret'] = "MzYyNHFpNzNkekFydFowaXB1Y0g0VDExY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
